...
public class JedisConfiguration {
  ...
  public static JedisPool getPool() {
    if (JedisConfiguration.jedisPool == null) {
      ...
      // The max objects to be allocated by the pool. If total is reached, the pool is exhausted.
      ...
      // The minimum time that an object can be idle in the pool before eviction due to idle
